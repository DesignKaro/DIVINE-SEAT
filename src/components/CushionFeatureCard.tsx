    ...
    >
      ...
      <div className="relative w-[290px] sm:w-[320px] h-[155px] sm:h-[160px] transition-transform duration-500 hover:-translate-y-1">
        ...
        <div
          ...
          style={{
            clipPath: "url(#glass-notch-clip-cushion)",
            WebkitClipPath: "url(#glass-notch-clip-cushion)",
        ...
        >
          <defs>
            <clipPath id="glass-notch-clip-cushion" clipPathUnits="userSpaceOnUse">
            ...
            <linearGradient id="card-glass-fill-cushion" x1="0" y1="0" x2="320" y2="160" gradientUnits="userSpaceOnUse">
            ...
            <linearGradient id="card-glass-border-cushion" x1="0" y1="0" x2="320" y2="160" gradientUnits="userSpaceOnUse">
          ...
          <path
            ...
            fill="url(#card-glass-fill-cushion)"
            stroke="url(#card-glass-border-cushion)"
            strokeWidth="1.6"
