...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          This Privacy Policy explains how Divine Lotus collects, uses, and protects your personal information when you visit our website, use our customization tools, or purchase a seat.
        </p>
        <p className="mt-2.5">
          We collect only the information necessary to fulfill orders, provide customer support, and ensure the website functions properly. We do not sell or rent your personal data to third parties.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-3">
          We collect information directly from you when you place an order, configure a seat, or contact support:
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-3">
          <div className="p-4 rounded-2xl bg-[#EFECE5]">
            <div className="font-bold text-[#1E140D] text-[13.5px] mb-1">
              Contact & Shipping
            </div>
            <p className="text-[12.5px] leading-relaxed text-[#402E1D]/80">
              Name, email address, delivery address, billing address, and phone number for shipping and order updates.
            </p>
          </div>
          <div className="p-4 rounded-2xl bg-[#EFECE5]">
            <div className="font-bold text-[#1E140D] text-[13.5px] mb-1">
            ...
            <p className="text-[12.5px] leading-relaxed text-[#402E1D]/80">
              Selected product model, colorway options, custom notes, and order transaction history.
            </p>
          </div>
          <div className="p-4 rounded-2xl bg-[#EFECE5]">
            <div className="font-bold text-[#1E140D] text-[13.5px] mb-1">
            ...
            <p className="text-[12.5px] leading-relaxed text-[#402E1D]/80">
              Processed securely through tokenized payment providers (Stripe, Apple Pay). We do not store credit card numbers on our servers.
            </p>
          </div>
          <div className="p-4 rounded-2xl bg-[#EFECE5]">
            <div className="font-bold text-[#1E140D] text-[13.5px] mb-1">
            ...
            <p className="text-[12.5px] leading-relaxed text-[#402E1D]/80">
              IP address, browser type, operating system, and basic analytics used to ensure website stability and performance.
            </p>
          </div>
        </div>
      </>
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-1.5 pl-1 text-[13.5px]">
          <li>To process and deliver your orders and manage shipping logistics.</li>
          <li>To handle customer service inquiries, warranty claims, and return requests.</li>
          <li>To communicate order confirmations, dispatch notices, and tracking numbers.</li>
          <li>To send product updates or newsletters if you have opted in (you can unsubscribe at any time).</li>
          <li>To meet accounting, tax, and legal compliance obligations.</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          We use functional cookies to save your cart items, remember language/currency preferences, and maintain checkout sessions. We do not use third-party data broker or cross-site advertising tracking cookies.
        </p>
        <p className="mt-2.5">
          You can adjust or disable cookie settings in your browser at any time.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          We share data only with service providers essential to running our business:
        </p>
        <ul className="list-disc list-inside space-y-1.5 my-3 pl-1 text-[13.5px]">
          <li><strong>Payment Processors:</strong> Stripe, Apple Pay, Google Pay (PCI-DSS compliant).</li>
          <li><strong>Shipping Carriers:</strong> DHL Express, FedEx, UPS (name and delivery address only).</li>
          <li><strong>Cloud Hosting:</strong> Vercel and AWS for secure site hosting and data storage.</li>
        </ul>
        <p>
          These providers are contractually required to protect your data and are prohibited from using it for any other purpose.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          We do not sell, rent, trade, or monetize your personal information to any third parties or advertisers.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          All data in transit is encrypted using standard SSL/TLS protocols. Order and customer records are stored securely with restricted access.
        </p>
        <p className="mt-2.5">
          We retain order and transaction records only as long as necessary to provide customer support, honor warranties, and satisfy statutory tax and commercial recordkeeping laws.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">Under applicable data protection laws (including GDPR and CCPA), you have the right to:</p>
        <ul className="list-disc list-inside space-y-1.5 pl-1 text-[13.5px]">
          <li>Access the personal data we hold about you.</li>
          <li>Request correction of inaccurate or incomplete information.</li>
          <li>Request deletion of your personal data, subject to statutory retention limits.</li>
          <li>Opt out of marketing communications at any time.</li>
        </ul>
        <p className="mt-3">
          To exercise any of these rights, contact us at <span className="font-semibold text-[#876540]">privacy@divinelotus.com</span>.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          If you have any questions about this Privacy Policy or how your data is handled, please reach out to:
        </p>
        <div className="mt-3 p-4 rounded-2xl bg-[#EFECE5]">
          <div className="font-bold text-[#1E140D] text-[13.5px]">Divine Lotus Privacy Desk</div>
          <a 
            href="mailto:privacy@divinelotus.com"
            className="text-[#876540] hover:text-[#1E140D] font-bold text-[13px] transition-colors mt-1 block"
          >
            privacy@divinelotus.com
          </a>
        </div>
      </>
    ),
    ...
    <main className="min-h-screen bg-[#ECE7DE] text-[#402E1D] flex flex-col justify-between overflow-x-clip">
      ...
      >
        ...
        >
          ...
          >
            How we handle and protect your personal information when you use our website or purchase The Lotus Seat.
          </motion.p>
      ...
      <section data-header-theme="light" className="py-8 sm:py-16 lg:py-20 px-4 sm:px-8 lg:px-16 bg-[#ECE7DE]">
        <div className="max-w-[1360px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-start">
          ...
          >
            ...
            <div className="p-5 rounded-[22px] bg-white text-[#402E1D] space-y-3">
              ...
              <p className="font-sans text-[12px] text-[#402E1D]/75 leading-relaxed">
                Contact our team directly for any data inquiries.
              </p>
              <div className="pt-1">
                <a
                  href="mailto:privacy@divinelotus.com"
          ...
          <div className="lg:col-span-8 space-y-4 sm:space-y-6 font-sans">
            ...
            {/* Mobile Bottom Quick Contact Box */}
            <motion.div 
            ...
            >
              ...
              <p className="font-sans text-[12.5px] text-[#402E1D]/80 leading-relaxed">
                Our team is available to assist with any questions or data requests.
              </p>
              <div className="pt-1">
                <a
                  href="mailto:privacy@divinelotus.com"
